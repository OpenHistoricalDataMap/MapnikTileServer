...
DATABASES["ohdm"]["ENGINE"] = "django.contrib.gis.db.backends.postgis"
...
MIGRATION_MODULES = {"sites": "ohdm_django_mapnik.contrib.sites.migrations"}
...
ADMINS = [("""OHDM Team""", "mail@ohdm.net")]
...
# PostGis
os.environ["PGUSER"] = env("POSTGRES_USER")
os.environ["PGPASSWORD"] = env("POSTGRES_PASSWORD")
os.environ["PGDATABASE"] = env("POSTGRES_DB")
os.environ["PGHOST"] = env("POSTGRES_HOST")
