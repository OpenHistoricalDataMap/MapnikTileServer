...
class Ohdm2Mapnik:
    ...
    def __init__(self, bulk_amount: int = 100000, sql_chunk_size: int = 100000):
        """
    ...
    def run(self):
        ...
        for geoobject in OhdmGeoobject.objects.all().iterator(
            chunk_size=self.sql_chunk_size
        ):

            if not geoobject.name:

                done_objects: List[int] = []
                ...
                for geoobject_geometry in OhdmGeoobjectGeometry.objects.filter(
                    ...
                    if geoobject_geometry.id in done_objects:
                        continue
                    ...
                    if (
                        ...
                        for (
                            ...
                            done_objects.append(geoobject_geometry_sub.id)
