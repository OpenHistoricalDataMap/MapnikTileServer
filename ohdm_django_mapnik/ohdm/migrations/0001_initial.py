    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateField(blank=True, null=True)),
                ('deleted', models.DateField(blank=True, null=True)),
                ('inner_members', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=256), size=None), blank=True, null=True, size=None)),
                ('outer_members', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=256), size=None), blank=True, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('visible', models.BooleanField()),
                ('nodes', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None), blank=True, null=True, size=None)),
                ('way', django.contrib.gis.db.models.fields.LineStringField(blank=True, null=True, srid=3857)),
                ('timestamp', models.DateField(blank=True, null=True)),
                ('deleted', models.DateField(blank=True, null=True)),
                ('tags', django.contrib.postgres.fields.hstore.HStoreField(blank=True, null=True)),
