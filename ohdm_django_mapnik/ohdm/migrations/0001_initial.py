    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_system_id', models.ForeignKey(blank=True, db_column='external_system_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmExternalSystems')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_user_id', models.ForeignKey(blank=True, db_column='source_user_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmExternalUsers')),
            ],
            options={
                'db_table': 'lines',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('line_id', models.ForeignKey(blank=True, db_column='line_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmLines')),
                ('point_id', models.ForeignKey(blank=True, db_column='point_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmPoints')),
                ('polygon_id', models.ForeignKey(blank=True, db_column='polygon_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmPolygons')),
                ('target_id', models.ForeignKey(db_column='target_id', on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmGeoobject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_since_offset', models.BigIntegerField(blank=True, null=True)),
                ('valid_until_offset', models.BigIntegerField(blank=True, null=True)),
                ('classification_id', models.ForeignKey(blank=True, db_column='classification_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmClassification')),
                ('id_geoobject_source', models.ForeignKey(blank=True, db_column='id_geoobject_source', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmGeoobject')),
                ('source_user_id', models.ForeignKey(blank=True, db_column='source_user_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmExternalUsers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_since_offset', models.BigIntegerField(blank=True, null=True)),
                ('valid_until_offset', models.BigIntegerField(blank=True, null=True)),
                ('content_id', models.ForeignKey(blank=True, db_column='content_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmContent')),
                ('geoobject_id', models.ForeignKey(blank=True, db_column='geoobject_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='ohdm.OhdmGeoobject')),
            ],
            options={
