...
class Rel2pgsql:
    ...
    def set_last_timestamp(self) -> datetime:
        nodes: QuerySet = PlanetOsmNodes.objects.order_by("-timestamp")[:1]
        ways: QuerySet = PlanetOsmWays.objects.order_by("-timestamp")[:1]
        rels: QuerySet = PlanetOsmRels.objects.order_by("-timestamp")[:1]
